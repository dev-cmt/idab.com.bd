                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="file" name="image_path" id="image_path" class="form-control @error('image_path') is-invalid @enderror" value="{{ old('image_path', $blog->image_path) }}">
                                            @error('image_path')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <img class="img-fluid" src="{{asset('public')}}/{{$blog->image_path}}" alt="" width="45">
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="datetime-local" name="publish_date" id="publish_date" class="form-control @error('publish_date') is-invalid @enderror" value="{{ old('publish_date', $blog->publish_date) }}">
                                            @error('publish_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
